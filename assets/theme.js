...
$(document).ready(function() {
  ...
  $( ".grid_product" ).mouseover(function(e) {
    if($(e.target).hasClass('trigger_hover')) {
      $(this).find('img.back_image').show();
      $(this).find('img.front_image').hide();
    }
    else {
      $(this).find('img.back_image').hide();
      $(this).find('img.front_image').show();  
    }
  });

  $('.site-nav--mobile ul li a.contact').on('click', function(e) {
    $('.contact_info').toggleClass('show');
  });

  $('ul.site-nav li.Collections a').on('click', function(e) {
    $('.collection_links').toggleClass('show');
  });


  var pathname = window.location.pathname;
  if(pathname === '/pages/aw-2021') {
    $('.collection_links').addClass('show');
  }
  if(pathname === '/pages/aw21-campaign') {
    $('.collection_links').addClass('show');
  }
  if(pathname === '/pages/ss-2021-lookbook') {
    $('.collection_links').addClass('show');
  }
  
  $('form#AddToCartForm--product-template .product-form__item .single-option-radio input').each(function() {
    $(this).prop('checked', false);
    $(this).on('click', function() {
      $('.product-single__add-to-cart button').addClass('active');
    });
  });

  $('.chart_link').on('click', function(e) { 
    $('.size_chart').toggle();
  });
  ...
  $('.cm').on('click', function(e) { 
    ...
    $('.size_chart .inches').hide();
    $('.size_chart .centimetres').removeClass('hide');
  });

  $('.in').on('click', function(e) { 
    $(this).addClass('active');
    $('.cm').removeClass('active');
    $('.size_chart .inches').show();
    $('.size_chart .centimetres').addClass('hide');
  });
  ...
  // $('.details_wrapper').click(function(e) {
  //   if($(e.target).hasClass('show_social')) {
  //     $(this).find('p.title').css({'text-decoration': 'underline'});
  //     $('.more_details .show_social').show();
  //   }
  //   else {
  //     $('.more_details .show_social').hide();
  //     $('p.title').css({'text-decoration': 'none'});   
  //   }
  // });


  // var $video  = $('#shopify-section-home-blocks video'),
  //   $window = $(window); 
